package com.example.cs_finalproject.configuration;

import com.example.cs_finalproject.Utils.RSAKeyProperties;
...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(final RSAKeyProperties rsaKeyProperties) {
